 ...
 * Jennifer Fullerton
 * CreatureSparkle_MeshPos.shader
 * Creates a gently moving sparkle effect on a creature/material.
 *
 * Combines multiple texture layers and UV manipulation to cause stars to move
 * across and overlay.
 */
